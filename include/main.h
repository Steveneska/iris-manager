...
enum ResourceImages
{
	...
	IMG_BUTTON_R3 = 25,
	IMG_BUTTON_RIGHT = 26,
	IMG_BUTTON_SELECT = 27,
	IMG_BUTTON_SQUARE = 29,
	IMG_BUTTON_START = 30,
	IMG_BUTTON_TRIANGLE = 31,
	IMG_BUTTON_UP = 32,
...
enum game_list_categories
{
	...
	GAME_LIST_RETRO    = 2,  // Homebrew / Retro / NET
...
#define D_FLAG_PSX_ISO  (1<<23) // Can also be used to identify PS2 games
