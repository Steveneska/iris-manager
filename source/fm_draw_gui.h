...
void draw_file_manager()
{
	...
	DrawBox2(0, is_vsplit ? 48 : 32, 0, 848, is_vsplit ? (512 - 48) * 3/2: 256 - 32);
	...
	if(nentries1)
	{
		...
		for(int n = 0; n < (is_vsplit? 24 : 9); n++)
		{
			...
			else if(stat1.st_mode != 0xffffffff)
			{
	...
	if(nentries2)
	{
		...
		for(int n = 0; n < (is_vsplit? 24 : 9); n++)
		{
			...
			else if(stat2.st_mode != 0xffffffff)
			{
