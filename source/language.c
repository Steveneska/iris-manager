...
t_lngstr lang_strings[] =
{
	...
	{ DRAWGLOPT_TOOLS, "DRAWGLOPT_TOOLS"				, "Utilities" },
	{ DRAWGLOPT_REFRESH, "DRAWGLOPT_REFRESH"			, "Game List Filter" },
	...
	{ DRAWGLOPT_FTPSTOPED, "DRAWGLOPT_FTPSTOPED"		, "Server FTP Stopped\nRemoved FTP service on init." },
	...
	{ DRAWTOOLS_LANGUAGE_2, "DRAWTOOLS_LANGUAGE_2"	, "Custom File"},
	...
	{ PLUG_STORAGE1, "PLUG_STORAGE1"	, "Remember you to plug an USB storage massive device to create the fake disc event" },
	...
	{ GAMELIST_SCANNING1, "GAMELIST_SCANNING1"	, "Scanning PlayStation®3 Games. Please wait..." },
