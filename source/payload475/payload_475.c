...
{
   // TOC 4.75 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
...
{
   // TOC 4.76 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc =peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.78 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc =peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.81 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.82 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
      return (peekq(0x80000000002FCB68ULL) == 0x323031372F30382FULL); //timestamp: 2017/08/
   }
   else
   {
      return 0;
...
{
   // TOC 4.83 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
      return (peekq(0x80000000002FCB68ULL) == 0x323031382F30392FULL); //timestamp: 2018/09/
   }
   else
   {
      return 0;
...
{
   // TOC 4.84 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
      return (peekq(0x80000000002FCB68ULL) == 0x323031392F30312FULL); //timestamp: 2019/01/
   }
   else
   {
      return 0;
...
{
   // TOC 4.85 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
      return (peekq(0x80000000002FCB68ULL) == 0x323031392F30382FULL); //timestamp: 2019/08/
   }
   else
   {
      return 0;
...
{
   // TOC 4.86 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
{
   // TOC 4.87 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
...
int is_firm_488(void)
{
   // TOC 4.88 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
      return (peekq(0x80000000002FCB68ULL) == 0x323032312F30342FULL); //timestamp: 2021/04/
   }
   else
   {
      return 0;
...
int is_firm_489(void)
{
   // TOC 4.89 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
      return (peekq(0x80000000002FCB68ULL) == 0x323032322F30322FULL); //timestamp: 2022/02/
   }
   else
   {
      return 0;
...
int is_firm_491(void)
{
   // TOC 4.91 (same as 4.75, 4.76, 4.78, 4.81, 4.82, 4.83, 4.84, 4.85, 4.86, 4.87, 4.88, 4.89, 4.91)
   u64 toc;
   toc = peekq(0x8000000000003000ULL);
   if(toc == 0x800000000034FBB0ULL)
   {
      return (peekq(0x80000000002FCB68ULL) >= 0x323032332F31322FULL); //timestamp: 2023/12/
   }
   else
   {
      return 0;
