...
edit_options:
					switch(function_menu)
					{
						...
						case 6:
							...
							{
								DrawDialogOKTimer("Mark is out of file size / memory", 2000.0f);
							}
							else
							{
						...
						case 8:
							...
							if(mark_flag == 2) {
								...
								DrawDialogOKTimer("Nothing to Copy", 2000.0f);
							break;
						case 9:
							enable_menu = function_menu = HEX_EDIT_MODE;
