 ...
 * Iris Manager (HMANAGER port 4.30) (c) 2012 D_Skywalk/Estwald
 *
 * HMANAGER4 is a free software: you can redistribute it and/or modify
...
void install_pkg(char *path, char *filename, u8 show_done)
{
	...
	{
		if(s.st_size + 0x40000000ULL > free_hdd0)
		{
