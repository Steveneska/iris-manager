...
void read_settings()
{
    ...
    strcpy(custom_homebrews, "HTSS00003|NETBROWSE|CDGPLAYER|GMPADTEST|IRISMAN00|BLES80616|IMANAGER4|GMANAGER9|MANAGUNZ0|PRXLOADER|RBGTLBOX2|BLES80608|BLES80688|SSNE10000|SSNE10001|RETROARCH|SNES90000|VBAM90000|GENP00001|FCEU90000|FBAN00000|FBAL00123|MAME90000|PSID81257|PS2L00123|ROGE12345|CNDR00001|BLJS10018|");
        ...
        if (fill_iso_entries_from_device(psxiso_path, PS1_FLAG, directories, &ndirectories, 0) > 0)
        {
...

            {
                if (strstr(directories[autolaunch].path_name, "/PSXISO") != NULL)
                    launch_iso_game(directories[autolaunch].path_name, EMU_PSX); // mount_game.h
                else
                {
...
int gui_control()
{
    ...
    #include "main_mount.h" // if(new_pad & BUTTON_CROSS_)
...
mount_game:
    ...
    launch_iso_game(directories[currentgamedir].path_name, DETECT_EMU_TYPE); // mount_game.h
