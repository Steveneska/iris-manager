...
int is_firm_481dex(void)
{
	...
	{
		return (peekq(0x800000000031F028ULL) == 0x323031362F31302FULL);
	}
	else
	{
		return 0;
...
int is_firm_482dex(void)
{
	...
	if(toc == 0x80000000003759C0ULL)
	{
		return (peekq(0x800000000031F028ULL) == 0x323031372F30382FULL);
	}
	else
	{
		return 0;
...
int is_firm_483dex(void)
{
	...
	if(toc == 0x80000000003759C0ULL)
	{
		return (peekq(0x800000000031F028ULL) == 0x323031382F30392FULL);
	}
	else
	{
		return 0;
...
int is_firm_484dex(void)
{
	...
	if(toc == 0x80000000003759C0ULL)
	{
		return (peekq(0x800000000031F028ULL) == 0x323031392F30312FULL);
	}
	else
	{
		return 0;
...
int is_firm_485dex(void)
{
	...
	if(toc == 0x80000000003759C0ULL)
	{
		return (peekq(0x800000000031F028ULL) == 0x323031392F30382FULL);
	}
	else
	{
		return 0;
...
int is_firm_486dex(void)
{
	...
	if(toc == 0x80000000003759C0ULL)
	{
		return (peekq(0x800000000031F028ULL) == 0x323032302F30312FULL);
	}
	else
	{
		return 0;
...
int is_firm_487dex(void)
{
   ...
   if(toc == 0x80000000003759C0ULL)
   {
	  return (peekq(0x800000000031F028ULL) == 0x323032302F30372FULL);
   }
   else
   {
	  return 0;
...
int is_firm_488dex(void)
{
   ...
   if(toc == 0x80000000003759C0ULL)
   {
	  return (peekq(0x800000000031F028ULL) == 0x323032312F30342FULL);
   }
   else
   {
	  return 0;
...
int is_firm_489dex(void)
{
   ...
   if(toc == 0x80000000003759C0ULL)
   {
	  return (peekq(0x800000000031F028ULL) == 0x323032332F30312FULL);
   }
   else
   {
	  return 0;
...
int is_firm_490dex(void)
{
   ...
   if(toc == 0x80000000003759C0ULL)
   {
	  return (peekq(0x800000000031F028ULL) >= 0x323032332F30332FULL) && (peekq(0x800000000031F028ULL) < 0x323032342F30322FULL);
   }
   else
   {
	  return 0;
...
int is_firm_49Xdex(void)
{
   ...
   if(toc == 0x80000000003759C0ULL)
   {
	  return (peekq(0x800000000031F028ULL) >= 0x323032342F30322FULL);
   }
   else
   {
	  return 0;
...
int is_payload_loaded_481dex(void)
{
	...
	{
		// New method to detect the payload
		addr&= 0xffffffff;
		if(addr) {
			restore_syscall8[0]= SYSCALL_BASE + (u64) (SYSCALL_SK1E * 8ULL);
	...
	addr = peekq(addr);
	if(peekq(addr - 0x20) == 0x534B313000000000ULL)
		return SKY10_PAYLOAD;
...
static inline void install_lv2_memcpy()
{
	...
	{
		// Install memcpy
		// This does not work on some PS3
...
void load_payload_481dex(int mode)
{
	...
	inst8 = 0x8000000000000000ULL + (u64) (PAYLOAD_OFFSET + 0x20);
